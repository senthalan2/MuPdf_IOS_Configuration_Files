...
- (instancetype) initWithFilename: (NSString*)nsfilename path:(NSString *)path document:(MuDocRef *)aDoc isEnableAnnot:(BOOL) isEnableAnnot continuePage:(NSNumber *) continuePage;
