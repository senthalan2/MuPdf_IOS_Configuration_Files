...
- (instancetype) initWithFilename: (NSString*)filename path:(NSString *)cstr document: (MuDocRef *)aDoc isEnableAnnot:(BOOL) isEnableAnnot continuePage:(NSNumber *) continuePage
{
