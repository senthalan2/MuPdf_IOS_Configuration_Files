...
- (void) onPasswordOkay
{
	MuDocumentController *document = [[MuDocumentController alloc] initWithFilename: _filename path:_filePath document: doc isEnableAnnot:isEnableAnnotButton continuePage:continuePageNumber];
	if (document) {
