...
CGImageRef CreateCGImageWithPixmap(fz_pixmap *pix, CGDataProviderRef cgdata)
{
  ...
  CGImageRef cgimage;
    ...
    if (@available(iOS 17.0, *)) {
      cgimage = CGImageCreate(w, h, 8, 32, 4 * w, cgcolor,(CGBitmapInfo)kCGImageAlphaPremultipliedLast, cgdata, NULL, NO, kCGRenderingIntentDefault);
    }
    else {
      cgimage = CGImageCreate(w, h, 8, 32, 4 * w, cgcolor, kCGBitmapByteOrderDefault, cgdata, NULL, NO, kCGRenderingIntentDefault);
    }
